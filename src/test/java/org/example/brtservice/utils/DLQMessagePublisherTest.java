 ...
 * Проверяют корректность отправки сообщений в Dead Letter Queue (DLQ).
 */
...
class DLQMessagePublisherTest {
    ...
    void setUp() {
        ...
        when(hrsServiceClient.getSystemDatetime()).thenReturn(testDateTime);
    }
    ...
    void publishToDLQ_shouldEnhanceMessageAndSend() {
        ...
        verify(hrsServiceClient).getSystemDatetime();
    }
}
